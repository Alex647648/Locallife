        ...
        <main className={`px-8 md:px-16 py-16 transition-all duration-500 ${sidebarOpen ? 'mr-[400px]' : 'mr-0'}`}>
          ...
          <footer className="max-w-7xl mx-auto border-t border-slate-100 py-16 grid grid-cols-1 md:grid-cols-3 gap-16">
             ...
             <div className="col-span-2 grid grid-cols-2 gap-10">
                ...
                <div><h4 className="text-[10px] font-bold uppercase tracking-widest text-slate-900 mb-6">Network</h4><ul className="text-xs font-bold text-slate-400 space-y-4 uppercase tracking-widest"><li><a href="https://ethereum.org" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600">Ethereum</a></li><li><a href="https://eips.ethereum.org/EIPS/eip-8004" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600">ERC-8004</a></li><li><a href="https://github.com/Alex647648/Locallife" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600">Github</a></li></ul></div>
             </div>
          </footer>
        </main>
